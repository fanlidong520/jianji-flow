...
def _create_or_copy_voiceover(
    ...
    *,
    ...
    if tts_provider == "edge":
        return create_edge_voiceover(recipe, output_path)
    if has_local_chinese_tts():
        return create_voiceover(recipe, output_path)
    if has_edge_tts():
        return create_edge_voiceover(recipe, output_path)
    return create_voiceover(recipe, output_path)
...
def _run_pipeline(
    ...
    *,
    ...
    try:
        ...
        _create_or_copy_voiceover(
            recipe,
            voiceover_path,
            getattr(args, "voiceover", None),
            tts_provider=getattr(args, "tts_provider", "auto"),
        )
